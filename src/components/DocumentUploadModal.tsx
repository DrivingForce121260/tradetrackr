...
const DocumentUploadModal: React.FC<DocumentUploadModalProps> = ({
  ...
  const defaultCategories: DocumentCategory[] = [
    ...
    },
    {
      ...
      concernID,
      name: 'Vertrö¤ge',
      description: 'Vertrö¤ge und rechtliche Dokumente',
      icon: 'ðŸ“‹',
      color: '#10B981',
    ...
    try {
      for (const item of uploadItems) {
        try {
          ...
          // Thumbnail generieren (falls mö¶glich)
      ...
      if (successCount > 0) {
        ...
        if (errorCount === 0) {
          // Alle erfolgreich - Modal schlieöŸen
          setTimeout(() => {
            onSuccess();
          }, 1500);
        }
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-lg font-medium text-gray-900 mb-2">
              Dateien hierher ziehen oder klicken zum Auswö¤hlen
            </p>
          ...
          {uploadItems.length > 0 && (
            <div className="space-y-4">
              <h3 className="text-lg font-medium">Ausgewö¤hlte Dateien ({uploadItems.length})</h3>
              ...
              {uploadItems.map((item) => (
                <div key={item.id} className="border rounded-lg p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor={`priority-${item.id}`}>Prioritö¤t</Label>
                      <Select
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="public">ö–ffentlich</SelectItem>
                          <SelectItem value="restricted">Eingeschrö¤nkt</SelectItem>
            ...
            >
              {isUploading ? (
                ...
                <>
                  ...
                  {uploadItems.length} Dokumente hochladen
                </>
              )}
            </Button>
          </div>
