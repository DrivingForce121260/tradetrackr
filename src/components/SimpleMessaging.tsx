...
const SimpleMessaging: React.FC<SimpleMessagingProps> = ({ isButton = false }) => {
  ...
  const [chats, setChats] = useState<SimpleChat[]>([
    {
      ...
      messages: [
        {
          id: '1',
          text: 'Hallo! Wie lö¤uft das Projekt?',
          sender: 'Anna Schmidt',
        ...
        {
          id: '2',
          text: 'Kö¶nnen wir heute noch kurz telefonieren?',
          sender: 'Anna Schmidt',
  ...
  // Keine Position-Korrektur nö¶tig - verwende feste Position unter Header
