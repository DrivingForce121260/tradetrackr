      ...
      <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
        <CollapsibleContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              <Label htmlFor="filter-documentType">Dokumententyp</Label>
              <Select
            ...
            {/* Prioritö¤t Filter */}
            <div>
              <Label htmlFor="filter-priority">Prioritö¤t</Label>
              <Select
                value={filters.priority || ''}
                onValueChange={(value) => updateFilter('priority', value || undefined)}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Alle Prioritö¤ten" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="">Alle Prioritö¤ten</SelectItem>
            ...
            {/* Projektphase Filter */}
            <div>
              <Label htmlFor="filter-projectPhase">Projektphase</Label>
              <Input
            ...
            {/* Upload von Filter */}
            <div>
              <Label htmlFor="filter-uploadedBy">Upload von</Label>
              <Input
            ...
            {/* Datum von Filter */}
            <div>
              <Label htmlFor="filter-dateFrom">Datum von</Label>
              <Input
                id="filter-dateFrom"
                type="date"
            ...
            {/* Datum bis Filter */}
            <div>
              <Label htmlFor="filter-dateTo">Datum bis</Label>
              <Input
                id="filter-dateTo"
                type="date"
