...
export default function ProjectInformation({ onBack, onNavigate, onOpenMessaging }: ProjectInformationProps) {
  ...
  useEffect(() => {
    if (user) {
      ...
      const demoProjects: ExtendedProject[] = [
        { 
          id: '1', 
          name: 'Bürogebö¤ude Renovierung', 
          description: 'Renovierung des Bürogebö¤udes',
          status: 'active',
          ...
          city: 'München',
          postalCode: '80331',
          workLocation: 'Bürogebö¤ude München',
          workAddress: 'Münchener Str. 1',
          workCity: 'München',
          workPostalCode: '80331',
          workLocationNotes: 'Hauptgebö¤ude, 3. Stock',
          notes: 'Elektroinstallation für Bürogebö¤ude',
      ...
      const demoProjectInfos: ProjectInfo[] = [
        {
          ...
          description: 'Detaillierter Grundriss des Bürogebö¤udes mit allen Rö¤umen und Abmessungen',
          type: 'diagram',
        ...
        },
        {
          ...
          projectNumber: 'PRJ-001',
          title: 'Materialliste',
          description: 'Vollstö¤ndige Liste aller benö¶tigten Materialien mit Mengen und Preisen',
          type: 'checklist',
          content: '1. Kabel und Leitungen\n2. Schalter und Steckdosen\n3. Sicherungskö¤sten\n4. Beleuchtungskö¶rper\n5. Werkzeuge',
        ...
        },
        {
          ...
          description: 'Vollstö¤ndiger Abschlussbericht der Industriehalle mit Fotos und Dokumentation',
          type: 'pdf',
          content: 'Vollstö¤ndiger Abschlussbericht mit Fotos und Dokumentation',
          uploadedBy: 'Max Mustermann',
  ...
  const handleDelete = (info: ProjectInfo) => {
    if (window.confirm(`Mö¶chten Sie "${info.title}" wirklich lö¶schen?`)) {
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">
                  Verwalten Sie projektspezifische Informationen, Checklisten, Dokumente und Leistungsverzeichnisse
                </p>
                {!canManageInfo && (
                  <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-md">
                    <p className="text-sm text-blue-700">
                      <Eye className="h-5 w-5 inline mr-1" />
                      Sie haben nur Lesezugriff auf Projektinformationen.
                    </p>
                  </div>
                )}
              </div>
            ...
            <Card className="border-blue-200 bg-blue-50">
              <CardHeader>
                <CardTitle className="text-lg text-blue-900 flex items-center gap-2">
                  ...
                  Ausgewö¤hltes Projekt
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div>
                    <Label className="text-sm font-medium text-blue-700">Projektnummer</Label>
                    <p className="text-lg font-semibold text-blue-900">{selectedProjectFromPM.projectNumber}</p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium text-blue-700">Projektname</Label>
                    <p className="text-lg font-semibold text-blue-900">{selectedProjectFromPM.name}</p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium text-blue-700">Status</Label>
                    <Badge variant={
                      selectedProjectFromPM.status === 'active' ? 'default' :
                      selectedProjectFromPM.status === 'planned' ? 'secondary' :
                      selectedProjectFromPM.status === 'completed' ? 'success' :
                      'outline'
                    }>
                  ...
                  <div>
                    <Label className="text-sm font-medium text-blue-700">Kunde</Label>
                    <p className="text-lg text-blue-900">{selectedProjectFromPM.customerName}</p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium text-blue-700">Projektmanager</Label>
                    <p className="text-lg text-blue-900">{selectedProjectFromPM.assignedManager}</p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium text-blue-700">Beschreibung</Label>
                    <p className="text-sm text-blue-900 line-clamp-2">{selectedProjectFromPM.description}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>
                  <div className="flex items-center gap-2">
                    Projektinformationen ({sortedInfos.length})
                    {selectedProjectFromPM && (
                      <Badge variant="outline" className="text-sm bg-blue-50 text-blue-700 border-blue-200">
                        Gefiltert für: {selectedProjectFromPM.projectNumber} - {selectedProjectFromPM.name}
                      </Badge>
                    )}
                  </div>
                </CardTitle>
                ...
                <div className="border border-gray-200 rounded-lg p-6 bg-white shadow-sm mb-6">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p className="text-gray-600">
                        Alle für das ausgewö¤hlte Projekt hochgeladenen Dokumente
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
                      <Button
      ...
      {canAddInfo && (
        <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
          <DialogContent className="max-w-4xl">
            <DialogHeader>
              <DialogTitle>Neue Projektinformation hinzufügen</DialogTitle>
              <DialogDescription>
                Fügen Sie neue Projektinformationen hinzu und laden Sie zugehö¶rige Dokumente hoch.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6">
              {/* Project Selection */}
              <div>
                <Label htmlFor="project">Projekt auswö¤hlen</Label>
                <select
                  id="project"
                ...
                >
                  <option value="">Projekt auswö¤hlen</option>
                  {filteredProjects.map(project => (
                    <option key={project.id} value={project.id}>
                      {project.projectNumber} - {project.name}
                    </option>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="diagram">Diagramm</option>
            ...
            <div className="flex justify-end gap-2 mt-6">
              ...
              <Button onClick={handleAddInfo} className="bg-[#058bc0] hover:bg-[#047aa0]">
                Hinzufügen
              </Button>
            </div>
          </DialogContent>
        ...
        <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
          <DialogContent className="max-w-4xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Bearbeiten Sie die Projektinformation und laden Sie zugehö¶rige Dokumente hoch.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6">
              {/* Project Selection */}
              <div>
                <Label htmlFor="edit-project">Projekt auswö¤hlen</Label>
                <select
                  id="edit-project"
                  value={formData.projectId}
