...
const ReportForm: React.FC<ReportFormProps> = ({ open, onOpenChange, onSubmit, user }) => {
  ...
  const handleProjectChange = (projectNumber: string) => {
    const projectData = {
      'PRJ-2024-001': { customer: 'München Immobilien GmbH', workLocation: 'München, Maximilianstraße 1' },
      'PRJ-2024-002': { customer: 'Hamburg Wohnbau AG', workLocation: 'Hamburg, Musterstraße 123' },
      'PRJ-2024-003': { customer: 'Berlin Shopping Center GmbH', workLocation: 'Berlin, Alexanderplatz 5' },
      'PRJ-2024-004': { customer: 'Frankfurt Krankenhaus Stiftung', workLocation: 'Frankfurt, Hauptstraße 42' },
      'PRJ-2024-005': { customer: 'Köln Schulamt', workLocation: 'Köln, Schulstraße 10' }
    };
