  ...
  const generateDemoTasks = () => {
    const demoTasks = [
      ...
      // PRJ-2024-002: Wohnkomplex Hamburg
      {
        ...
        priority: 'high',
        status: 'completed',
        title: 'Sanitärarbeiten in Wohnung 3A',
      ...
      },
      {
        ...
        description: 'Heizkörper tauschen und Thermostate installieren'
      }
    ];
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-white/20">
                    ...
                    <TableHead className="text-white">Fällig</TableHead>
                    <TableHead className="text-white">Priorität</TableHead>
